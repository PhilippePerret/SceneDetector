...
class ScenePatternDetector:
    def __init__(self):
        ...
        # Charger BLIP pour l'analyse visuelle
    ...
    def _initialize_scene_detectors(self):
        ...
        return {
            ...
            'voiture': {
                'visual_keywords': ['voiture', 'car', 'auto', 'vehicle', 'conduire', 'driving', 'road', 'route'],
                'audio_keywords': ['rouler', 'drive', 'conduire', 'car', 'voiture'],
                'min_duration': 20
            },
            'sport_affrontement': {
    ...
    def detect_voiture(self, frames_analysis, criteria):
        """Détecte les scènes de voiture"""
        return self.detect_keyword_based_scene(frames_analysis, criteria, 'voiture')
