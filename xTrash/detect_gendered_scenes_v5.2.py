...
'''
        ...
        for scene in all_scenes_sorted:
            ...
            html += f'''
                <div class="scene-item {style_class}" data-start="{start_seconds}" data-end="{scene.get('end_timecode', start_seconds)}">
    ...
    <script>
        ...
        function updateSelection() {
            ...
            allSceneItems.forEach(item => {
                ...
                const end = parseFloat(item.dataset.end) || (start + 300); // Par défaut 5 min
                ...
                if (currentTime >= start && currentTime < end) {
                    ...
                    item.classList.remove('selected', 'was-selected');
                }
            });
        }
